...
if (!file_exists($promptLoaderPath)) {
    $featureUnavailableMessage = 'Modul Prompt Control belum ter-install di environment ini (services/PromptLoader.php tidak ditemukan). Jalankan installer/migration untuk mengaktifkannya.';
    require dirname(__DIR__) . '/includes/feature-unavailable.php';
    exit;
}
